 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://webService.com/web", wsdlLocation = "http://localhost:8080/webService/userWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://webService.com/web", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webService/userWebService?wsdl");
    ...
    public UserWebService getUserServiceImplPort() {
        return super.getPort(new QName("http://webService.com/web", "UserServiceImplPort"), UserWebService.class);
    }
     ...
     */
    @WebEndpoint(name = "UserServiceImplPort")
    public UserWebService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService.com/web", "UserServiceImplPort"), UserWebService.class, features);
    }
